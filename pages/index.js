  ...
  return (
    <div className='relative overflow-x-hidden z-20'>
      <Head>
        ...
        <meta property='og:image:secure_url' content='https://i.ibb.co/YW6T1vp/Ecommerce-Shop.png' />
      ...
      <div className=' container mx-auto'>
        {/* <pre className='h-96 overflow-y-scroll'>{JSON.stringify(products, null, 2)}</pre> */}
        <Main data={products} />
      </div>
      <Footer />
    </div>
